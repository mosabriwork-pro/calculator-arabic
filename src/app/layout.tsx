  ...
  return (
    <html lang="ar" dir="rtl">
      <head>
        ...
        <link rel="icon" type="image/png" sizes="48x48" href="/logofavicon.png" />
        <link rel="icon" type="image/png" sizes="64x64" href="/logofavicon.png" />
        <link rel="icon" type="image/png" sizes="96x96" href="/logofavicon.png" />
        <link rel="icon" type="image/png" sizes="128x128" href="/logofavicon.png" />
        <link rel="icon" type="image/png" sizes="192x192" href="/logofavicon.png" />
        <link rel="icon" type="image/png" sizes="256x256" href="/logofavicon.png" />
